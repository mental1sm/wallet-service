package com.wallet.presentation.servlets.client.util;
...
public class KeycloakContextExtractor {
    ...
    */
    public static Map<String, Object> getSecurityContextFromAccessToken(HttpServletRequest request) throws NoSuchAlgorithmException, InvalidKeySpecException, UnauthorizedException {
