...
public interface AccountService {
     ...
     * @return
     */
    boolean regUser(String name, String surname, String pLogin, String pPassword) throws PlayerAllreadyExistsException, PlayerIsNotExistsException;
     ...
     * @return
     */
    boolean authUser(String pLogin, String pPassword) throws PlayerIsNotExistsException, InvalidPasswordException;
}
